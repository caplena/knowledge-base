...
3. (Optional) Add **project context** — such as the goal, audience, or product you're analyzing. This helps the AI generate more relevant insights.
...
2. Caplena auto-detects **open text columns**, select the ones you want to analyze
...
- **Start from scratch** and let Caplena auto-generate topics
- **Import** a predefined topic collection
- **Reuse** topics from a previous project

Caplena creates a list of topics and organizes them into categories
You can:
- Rename, merge, or delete topics
- Create your own categories or topics
