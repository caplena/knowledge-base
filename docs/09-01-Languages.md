...
## Auto-Translation
You can enable [automatic translations](#auto-translations-in-detail) with the click of a button. Through that functionality, the application will work on practically any language.
