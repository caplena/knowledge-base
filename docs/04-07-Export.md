...
When exporting from the [fine-tuning view](docs/06-01-Fine-tuning-view.md), the generated export will respect the [filters](docs/06-01-Fine-tuning-view.md#filters) that you have applied - only the rows matching the current filters will be exported. To export all rows, simply clear any applied fields.
